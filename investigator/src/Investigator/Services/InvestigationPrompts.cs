...
internal static class InvestigationPrompts
{
        ...
        string defaultProfileName)
    {
        ...
        return $$"""
            ...
            5. To inspect CI job definitions, step registry configs, or cluster manifests, use release_repo to get the local clone path, then read files with run_shell.
